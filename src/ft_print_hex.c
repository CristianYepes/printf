...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/05/11 01:07:28 by cristian          #+#    #+#             */
/*   Updated: 2026/05/11 01:07:30 by cristian         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_print_x(char *nbstr, unsigned int n, int is_upper, t_flags *flags)
{
	int	count;
...
int	ft_print_hexadec(char *nbstr, unsigned int n, int is_upper, t_flags *flags)
{
	int	count;
